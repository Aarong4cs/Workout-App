...
class ExerciseDatabasePage(BasePage):
    def __init__(self, parent, app):
        ...
        left = ttk.Labelframe(
            self.content, text="Exercise Database", padding=10, bootstyle=INFO
        )
        left.grid(row=0, column=0, sticky="nsew", padx=(10, 5), pady=10)

        right = ttk.Labelframe(
            self.content, text="Progress", padding=10, bootstyle=WARNING
        )
        ...
        self.graph_area.pack_propagate(True)
